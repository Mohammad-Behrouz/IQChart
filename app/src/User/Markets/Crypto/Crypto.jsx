                                        ...
                                        <span className="ltr change_percent iran-sans-font">
                                            {parseFloat(gold.change_percent_24h) > 0 ? (
                                                <span style={{ color: "green" }}>
                                                    <i className="fa-solid fa-triangle "></i> +{parseFloat(gold.change_percent_24h).toFixed(2).toLocaleString("fa")}%
                                                </span>
                                            ) : parseFloat(gold.change_percent_24h) < 0 ? (
                                                <span style={{ color: "red" }}>
                                                    ...
                                                    ></i>{" "}
                                                    {parseFloat(gold.change_percent_24h).toFixed(2).toLocaleString("fa")}%
                                                </span>
                                            ) : (
